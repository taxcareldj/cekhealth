...
"""
import http.server, urllib.parse, json, re, io, sys, os, traceback
...
def hasil_html(h, inp):
  ...
  <div class="up">
    <div><div class="up-t">Ingin TaxCare yang kelola segalanya?</div>
    <div class="up-s">Paket Full Compliance: pembukuan bulanan, laporan keuangan, dan SPT tahunan.</div></div>
    <a href="#" class="btn bs blg">Konsultasi Gratis →</a>
  </div>
</div>'''
